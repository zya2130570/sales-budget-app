...
export function useTransactions() {
  ...
  const [pdfPreviewRows, setPdfPreviewRows] = useState<Array<{ date: string; merchant: string; amount: number; rawSign: number; inferredType: 'income' | 'expense' | 'transfer' | 'credit card payment'; confidence: 'high' | 'medium' | 'low'; isDup?: boolean }>>([])
