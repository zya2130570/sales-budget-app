import type { Tab, Period, Category, SavedBudget, SavedScenarioSet, Target, SavedTargetSet, Account, Transaction, TransactionRule } from '../types'
...
export function loadAccounts(): Account[] | null {
  return storageGet<Account[]>(KEYS.accounts)
}

export function loadTransactions(): Transaction[] | null {
  return storageGet<Transaction[]>(KEYS.transactions)
}

export function loadTransactionRules(): TransactionRule[] | null {
  return storageGet<TransactionRule[]>(KEYS.transactionRules)
}
...
export function saveTransactions(transactions: Transaction[]): void {
  storageSet(KEYS.transactions, transactions)
}

export function saveTransactionRules(rules: TransactionRule[]): void {
  storageSet(KEYS.transactionRules, rules)
}
