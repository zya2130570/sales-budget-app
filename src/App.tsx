  ...
  const welcome = !hasBudgetData
    ...
    : selectedPeriodRemaining < 0
      ? topVariable
        ...
        : `You are over budget by ${currency(Math.abs(selectedPeriodRemaining))} ${periodPhrase}. Most of your spending is fixed, so review your largest bill first: ${topBill?.name ?? 'your top bill'}.`
